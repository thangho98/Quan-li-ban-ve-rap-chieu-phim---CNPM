...
(
	...
	alter table dbo.LichChieu add TrangThai INT NOT NULL DEFAULT '0', --0: Chưa tạo vé cho lịch chiếu || 1: Đã tạo vé
...
exec USP_InsertTicketByShowTimes @idlichChieu , @maGheNgoi